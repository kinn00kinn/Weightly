...
CREATE UNIQUE INDEX IF NOT EXISTS rate_limit_key_uidx ON "rateLimit"(key);
...
CREATE INDEX IF NOT EXISTS weights_user_measured_idx ON weights(user_id, measured_at);
